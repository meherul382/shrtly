export default async function handler(req,res){
  ...
  if(req.method==='DELETE'){
    res.setHeader('Set-Cookie','shrtigo_session=; Path=/; Max-Age=0; HttpOnly; Secure; SameSite=Lax');
  ...
  try{
    ...
    const cookie=`shrtigo_session=${encodeURIComponent(token)}; Path=/; Max-Age=2592000; HttpOnly; Secure; SameSite=Lax`;
