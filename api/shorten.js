...
function normalizeDomain(value) { const domain = String(value || '').trim().toLowerCase().replace(/^https?:\/\//,'').replace(/\/+$/,''); return ['shrtigo.xyz','shrtigo.shop','shrtigo.online','shrtigo.site','shrtigopro.site','shrtigo.world','shrtigo.store'].includes(domain) ? domain : null; }
