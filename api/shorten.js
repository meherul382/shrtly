...
function normalizeDomain(value) { const domain = String(value || '').trim().toLowerCase().replace(/^https?:\/\//,'').replace(/\/+$/,''); return ['shrtigo.xyz','adpage-builder.xyz','shrtigo.shop','shrtigo.online','shrtigo.site'].includes(domain) ? domain : null; }
